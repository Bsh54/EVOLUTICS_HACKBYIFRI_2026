    ...
    <div className="h-screen w-full overflow-y-auto overflow-x-hidden bg-[var(--theme-bg-primary)] text-[var(--theme-text-primary)] custom-scrollbar">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center px-6 py-20 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-10 w-72 h-72 rounded-full bg-[#3b82f6]/15 blur-3xl landing-float" />
          <div className="absolute bottom-20 right-10 w-96 h-96 rounded-full bg-[#2563eb]/10 blur-3xl landing-float-slow" />
          <div className="absolute top-1/3 right-1/4 w-64 h-64 rounded-full bg-[#8b5cf6]/10 blur-3xl landing-float-delayed" />
        </div>

        {/* Hero background illustration — stylized career/tech scene */}
        <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-[0.06]">
          <svg className="absolute bottom-0 left-0 w-full h-auto" viewBox="0 0 1440 600" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Cityscape / career growth silhouette */}
            <rect x="100" y="300" width="80" height="300" rx="8" fill="currentColor" />
            <rect x="200" y="200" width="60" height="400" rx="8" fill="currentColor" />
            <rect x="280" y="250" width="70" height="350" rx="8" fill="currentColor" />
            <rect x="380" y="150" width="90" height="450" rx="8" fill="currentColor" />
            <rect x="500" y="220" width="60" height="380" rx="8" fill="currentColor" />
            <rect x="580" y="180" width="80" height="420" rx="8" fill="currentColor" />
            <rect x="700" y="280" width="70" height="320" rx="8" fill="currentColor" />
            <rect x="790" y="120" width="100" height="480" rx="8" fill="currentColor" />
            <rect x="920" y="200" width="60" height="400" rx="8" fill="currentColor" />
            <rect x="1000" y="160" width="80" height="440" rx="8" fill="currentColor" />
            <rect x="1100" y="240" width="70" height="360" rx="8" fill="currentColor" />
            <rect x="1200" y="100" width="90" height="500" rx="8" fill="currentColor" />
            <rect x="1320" y="260" width="60" height="340" rx="8" fill="currentColor" />
            {/* Rising trend line */}
            <path d="M0 500 Q 200 480, 400 420 T 800 300 T 1200 150 T 1440 100" stroke="currentColor" strokeWidth="3" fill="none" strokeLinecap="round" />
            {/* Nodes on the trend */}
            <circle cx="400" cy="420" r="8" fill="currentColor" />
            <circle cx="800" cy="300" r="8" fill="currentColor" />
            <circle cx="1200" cy="150" r="10" fill="currentColor" />
            {/* Floating elements — documents, gears */}
            <rect x="300" y="80" width="50" height="65" rx="6" fill="currentColor" />
            <line x1="312" y1="95" x2="338" y2="95" stroke="var(--theme-bg-primary)" strokeWidth="2" />
            <line x1="312" y1="105" x2="338" y2="105" stroke="var(--theme-bg-primary)" strokeWidth="2" />
            <line x1="312" y1="115" x2="330" y2="115" stroke="var(--theme-bg-primary)" strokeWidth="2" />
            <rect x="1050" y="60" width="50" height="65" rx="6" fill="currentColor" />
            <line x1="1062" y1="75" x2="1088" y2="75" stroke="var(--theme-bg-primary)" strokeWidth="2" />
            <line x1="1062" y1="85" x2="1088" y2="85" stroke="var(--theme-bg-primary)" strokeWidth="2" />
            <line x1="1062" y1="95" x2="1080" y2="95" stroke="var(--theme-bg-primary)" strokeWidth="2" />
            {/* Graduation cap */}
            <polygon points="720,50 680,75 720,100 760,75" fill="currentColor" />
            <rect x="715" y="100" width="10" height="20" fill="currentColor" />
          </svg>
        </div>
